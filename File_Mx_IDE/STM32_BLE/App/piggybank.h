...
typedef enum
{
  ...
  PIGGYBANK_CHAROPCODE_LAST
} PIGGYBANK_CharOpcode_t;

typedef enum
{
  PIGGYBANK_COINS_NOTIFY_ENABLED_EVT,
  PIGGYBANK_COINS_NOTIFY_DISABLED_EVT,
  PIGGYBANK_LIMIT_READ_EVT,
  PIGGYBANK_LIMIT_WRITE_EVT,

  /* USER CODE BEGIN Service1_OpcodeEvt_t */

  /* USER CODE END Service1_OpcodeEvt_t */

  PIGGYBANK_BOOT_REQUEST_EVT
} PIGGYBANK_OpcodeEvt_t;
...
typedef struct
{
  PIGGYBANK_OpcodeEvt_t       EvtOpcode;
  PIGGYBANK_Data_t             DataTransfered;
